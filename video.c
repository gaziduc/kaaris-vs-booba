...
int playVideo(SDL_Renderer *renderer, Input *in, Fonts *fonts, char *filename)
{
	int rv = 0;
	...
	SDL_Rect pos_dst;
    SDL_Texture *texte = RenderTextBlended(renderer, fonts->ocraext_message, "Appuyez sur ENTREE pour passer la cinématique...", white);
